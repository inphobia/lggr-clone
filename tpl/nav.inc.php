...
<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="./do.php?a=reset"><img
                src="./img/logo.png" alt="Lggr.io" /></a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
            ...
            <form id="searchform" method="post"
                ...
                <div class="form-group">
                    <input id="prog" name="prog"
                        placeholder="<?= _('Search for program') ?>"
                        class="form-control" type="text"
                        value="<?= $searchvalueprog ?>"> <input id="q"
                        name="q"
                        placeholder="<?= _('Search in messages') ?>"
                        class="form-control" type="text"
                        value="<?= $searchvalue ?>">
                </div>
