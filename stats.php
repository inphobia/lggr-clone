        ...
        <div class="col-md-6">
            <h2>
                <span class="glyphicon glyphicon-time"
                    aria-hidden="true"></span> <?= _('Messages per hour') ?></h2>
            <canvas id="chartMsgsPerHour"></canvas>
        </div>
        <div class="col-md-6">
            <h2>
                <span class="glyphicon glyphicon-cd" aria-hidden="true"></span> <?= _('Servers') ?></h2>
        ...
        <div class="col-md-4">
            <h2>
                <span class="glyphicon glyphicon-signal"
                    aria-hidden="true"></span> <?= _('Message levels relative distribution') ?></h2>
            <canvas id="chartLevels"></canvas>
        </div>
        <div class="col-md-4">
            <h2>
                <span class="glyphicon glyphicon-cd" aria-hidden="true"></span> <?= _('Messages by server') ?></h2>
            <canvas id="chartServersPie"></canvas>
        </div>
        <div class="col-md-4">
            <h2>
